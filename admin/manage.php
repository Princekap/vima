								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									{				?>	
										<tr>
											...
											<td><img src="uploads/primary/<?php echo htmlentities($result->Passport_Picture);?>" style="width:60px; height:60px; border-radius:50%;"/></td>
                                            ...
                                            <td>
<a href="edit_record.php?edit=<?php echo $result->id;?>" onclick="return confirm('Do you want to Edit');"> <i class="fa fa-edit"></i></a>&nbsp;&nbsp;
<a href="manage.php?del=<?php echo $result->id;?>&name=<?php echo htmlentities($result->fullname);?>" onclick="return confirm('Do you want to Delete');"><i class="fa fa-trash" style="color:red"></i></a>&nbsp;&nbsp;
