...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['record']) && $_POST['randcheck']==$_SESSION['rand']) {
...
:childresidence
		...
		$query->bindParam(':Passport_Picture', $Passport_Picture, PDO::PARAM_STR);
		...
		$query->bindParam(':fatherpicture', $fatherpicture, PDO::PARAM_STR);
		...
		$query->bindParam(':motherpicture', $motherpicture, PDO::PARAM_STR);
		...
		$query->bindParam(':guardianpicture', $guardianpicture, PDO::PARAM_STR);
		...
		$query->bindParam(':sponsorpicture', $sponsorpicture, PDO::PARAM_STR);
		...
		if ($lastInsertId) {
			echo "<script type='text/javascript'>alert('Record Added Sucessfull!');</script>";
		} else {
		...
		<div class="ts-main-content">
			...
			<div class="content-wrapper">
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12">
							<h3 class="page-title text-center">Add Record</h3>
							<div class="row">
								<div class="col-md-12">
...
?>
										...
										<div class="panel panel-default">
											...
											<div class="panel-body">
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="file" name="Passport_Picture" class="form-control" required>
													</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" placeholder="ID Number" name="idnumber" id="idnumber" class="form-control"   onBlur="checkAvailabilityplot()" required>
														<span id="id-availability" style="font-size:12px;"></span>
													</div>
													...
													<div class="col-sm-4 select-editable">
														...
														<input type="text" value="VIMA" name="childresidence" placeholder="Place of Residence" />
													</div>
												</div>
												<div class="form-group">
													...
													<div class="col-sm-4">
														...
														<label class="radio-inline">
															<input type="radio" name="parentsalive" class="parentsalive" value="BOTH" onclick="showboth()" required/>BOTH </label>

														<label class="radio-inline">
															<input type="radio" name="parentsalive" class="parentsalive" value="FATHER" onclick="showfather()" />FATHER
														</label>
														<label class="radio-inline">
															<input type="radio" name="parentsalive" class="parentsalive" value="MOTHER" onclick="showmother()" />MOTHER
														</label>
														<label class="radio-inline">
															<input type="radio" name="parentsalive" class="parentsalive" value="NONE" onclick="showguardian()" />NONE
														</label>
											...
											<div class="panel-body">
												...
												<div class="showfather" id="fathersbox">
													...
													<div class="form-group">
														...
														<div class="col-sm-4">
															<input type="text" placeholder="Father's Name" name="fatherfullname" class="form-control">
														</div>

														<label class="col-sm-2 control-label">Place of Residence</label>
														<div class="col-sm-4">
															<input type="text" placeholder="Place of Residence" name="fatherresisdence" class="form-control">
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-4">
															<input type="text" placeholder="Father's Occupation" name="fatheroccupation" class="form-control">
														</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-4">
															<input type="text" placeholder="Father Contact" name="fathercontact" class="form-control" onkeypress="isInputNumber(event)">
														</div>
												...
												<div id="mothersbox" class="showmother">
													<div class="form-group">
														...
														<div class="col-sm-4">
															<input type="text" placeholder="Mother's Name" name="motherfullname" class="form-control">
														</div>

														<label class="col-sm-2 control-label">Place of Residence</label>
														<div class="col-sm-4">
															<input type="text" placeholder="Place of Residence" name="motherresisdence" class="form-control">
														</div>
													</div>
													...
													<div class="form-group">
														<label class="col-sm-2 control-label">Occupation</label>
														<div class="col-sm-4">
															<input type="text" placeholder="Mother's Occupation" name="motheroccupation" class="form-control">
														</div>
													...
													<div class="form-group">
														<label class="col-sm-2 control-label">Contact Number<span style="color:red">*</span></label>
														<div class="col-sm-4">
															<input type="text" placeholder="Mother Contact" name="mothercontact" class="form-control" onkeypress="isInputNumber(event)">
														</div>
												...
												<div id="guardianbox" class="showguardian">
													<div class="form-group">
														...
														<div class="col-sm-4">
															<input type="text" placeholder="Guardian's Name" name="guardianfullname" class="form-control">
														</div>

														<label class="col-sm-2 control-label">Place of Residence</label>
														<div class="col-sm-4">
															<input type="text" placeholder="Place of Residence" name="guardianresisdence" class="form-control">
														</div>
													</div>
													...
													<div class="form-group">
														<label class="col-sm-2 control-label">Occupation</label>
														<div class="col-sm-4">
															<input type="text" placeholder="Guardian's Occupation" name="guardianoccupation" class="form-control">
														</div>
													...
													<div class="form-group">
														<label class="col-sm-2 control-label">Contact Number<span style="color:red">*</span></label>
														<div class="col-sm-4">
															<input type="text" placeholder="Guardian Contact" name="guardiancontact" class="form-control" onkeypress="isInputNumber(event)">
														</div>
										...
										<div class="panel panel-default">
											...
											<div class="panel-body">
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" placeholder="Cantact Person Name" name="emergencyname" class="form-control">
													</div>

													<label class="col-sm-2 control-label">Emergency Contact<span style="color:red">*</span></label>
													<div class="col-sm-4">
														<input type="text" placeholder="Emergency Contact" name="emergencycontact" class="form-control" onkeypress="isInputNumber(event)">
													</div>
												</div>
											...
											<div class="panel-body">
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														...
														<label class="radio-inline">
															<input type="radio" name="sponsorship" class="sponsorship" value="YES" onclick="sponsored()" required/>YES </label>

														<label class="radio-inline">
															<input type="radio" name="sponsorship" class="sponsorship" selected value="NO" onclick="notsponsored()" />NO
														</label>
													</div>
												...
												<div id="sponsorbox" class="showsponsor">
													<div class="form-group">
														...
														<div class="col-sm-4">
															<input type="text" placeholder="Sponsor's Name" name="sponsorname" class="form-control">
														</div>

														<label class="col-sm-2 control-label">Place of Residence</label>
														<div class="col-sm-4">
															<input type="text" placeholder="Place of Residence" name="sponsorresisdence" class="form-control">
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-4">
															...
															<label class="radio-inline">
																<input type="radio" name="sponsormarried" class="sponsorship" value="YES" />YES </label>

															<label class="radio-inline">
																<input type="radio" name="sponsormarried" class="sponsorship" value="NO" />NO
															</label>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-4">
															<input type="text" placeholder="Name of Spouse" name="nameofspouse" class="form-control">
														</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-4">
															<input type="text" placeholder="Sponsor's Contact" name="sponsorcontact" class="form-control" onkeypress="isInputNumber(event)">
														</div>
														<div class="form-group">
													...
													<div class="col-sm-4">
														...
														<label class="radio-inline">
															<input type="radio" name="spondorshipstatus" class="sponsorship" value="Active"  checked required/>YES </label>

														<label class="radio-inline">
															<input type="radio" name="spondorshipstatus" class="sponsorship" selected value="Inactive"  />NO
														</label>
													</div>
													</div>
													</div>
										...
										<div class="panel panel-default">
											...
											<div class="panel-body">
												...
												<div class="form-group ">
													<label class="col-sm-2 control-label">Benefit From<span style="color:red">*</span></label>
													<div class="col-sm-4">
														<!-- <span > From:</span> -->
														<input type="date" name="benefitfrom" class="form-control" required>

													</div>
													<!-- <div class="col-sm-2">
														<span>To:</span>
														<input type="date" name="benefitto" class="form-control" required>

													</div> -->
													<label class="col-sm-2 control-label">Level of Education</label>
													<div class="col-sm-4">
														<input type="text" placeholder="Level of Education" name="educationlevel" class="form-control">
													</div>
												</div>
												<div class="form-group ">
													...
													<div class="col-sm-8">
														<textarea style="display:none" id="extratext" name="other_info" class="form-control" rows="5">
</textarea>
													</div>
												</div>
												...
												<div class="form-group">
													<div class="col-sm-10 col-sm-offset-6">
														<button class="btn btn-primary" style="background-color: #125e36;;" name="record" type="submit"><i class="fa fa-plus-square fa-lg" aria-hidden="true"></i> ADD RECORD</button>
													</div>
												</div>
		...
		<script>
			...
			function checkAvailabilityplot() {
                            $("#loaderIcon").show();
                            jQuery.ajax({
                                url: "availabilitycheck.php",
                                data: {
