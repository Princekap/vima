									...
									<button class="btn btn-primary" >VIEW TERMINAL REPORTS</button></a>
										  ...
										  <div id="record_details">
											...
											<tr><td></td>	</tr>									 	
											    ...
											    <td rowspan="5" ><img src="admin/uploads/primary/<?php echo $row->Passport_Picture;($result->Passport_Picture);?>" style="width:300px; height:300px; border-radius:0%;"/></td>
...
$.ajax({
      ...
      var user_id="<?php echo $row->motherpicture; ?>";
        location.href = "admin/uploads/parents/"+user_id;
    };
	...
	document.getElementById("sponsorImage").onclick = function () {
      var user_id="<?php echo $row->sponsorpicture; ?>";
        location.href = "admin/uploads/sponsor/"+user_id;
    };
